...
namespace Movie_Rental.Controllers
{
    public class CustomerInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerID,CustomerName,CustomerPhoneNumber")] CustomerInfo customerInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerID,CustomerName,CustomerPhoneNumber")] CustomerInfo customerInfo)
        {
            if (ModelState.IsValid)
            {
